...
exercise_1 = Exercise.create(name: 'barbell bench press', gif: "http://d205bpvrqc9yn1.cloudfront.net/0025.gif")
exercise_6 = Exercise.create(name: 'barbell incline bench press', gif: "http://d205bpvrqc9yn1.cloudfront.net/0047.gif")
exercise_7 = Exercise.create(name: 'barbell decline bench press', gif: "http://d205bpvrqc9yn1.cloudfront.net/0033.gif")
exercise_8 = Exercise.create(name: 'deep push up', gif: "http://d205bpvrqc9yn1.cloudfront.net/1274.gif")
exercise_9 = Exercise.create(name: 'dumbbell fly', gif: "http://d205bpvrqc9yn1.cloudfront.net/0308.gif")
# chest exercises ^^
exercise_2 = Exercise.create(name: 'alternate lateral pulldown', gif: "http://d205bpvrqc9yn1.cloudfront.net/0007.gif")
exercise_10 = Exercise.create(name: 'cable rope crossover seated row', gif: "http://d205bpvrqc9yn1.cloudfront.net/1320.gif")
exercise_11 = Exercise.create(name: 'pull up (neutral grip)', gif: "http://d205bpvrqc9yn1.cloudfront.net/0651.gif" )
exercise_12 = Exercise.create(name: 'rope climb', gif: "http://d205bpvrqc9yn1.cloudfront.net/0680.gif")
exercise_13 = Exercise.create(name: 'smith narrow row', gif: "http://d205bpvrqc9yn1.cloudfront.net/0761.gif")
# back exercises ^^
exercise_3 = Exercise.create(name: 'smith sumo squat', gif: "http://d205bpvrqc9yn1.cloudfront.net/3142.gif")
exercise_14 = Exercise.create(name: 'trap bar deadlift', gif: "http://d205bpvrqc9yn1.cloudfront.net/0811.gif")
exercise_15 = Exercise.create(name: 'weighted lunge with swing', gif: "http://d205bpvrqc9yn1.cloudfront.net/3644.gif" )
exercise_16 = Exercise.create(name: 'cable assisted inverse leg curl', gif: "http://d205bpvrqc9yn1.cloudfront.net/3235.gif")
exercise_17 = Exercise.create(name: 'lever leg extension', gif: "http://d205bpvrqc9yn1.cloudfront.net/0585.gif")
# leg day obvi lol
exercise_4 = Exercise.create(name: 'lever one arm shoulder press', gif: "http://d205bpvrqc9yn1.cloudfront.net/0590.gif")
exercise_18 = Exercise.create(name: 'dumbbell arnold press', gif: "http://d205bpvrqc9yn1.cloudfront.net/2137.gif")
exercise_19 = Exercise.create(name: 'dumbbell full can lateral raise', gif: "http://d205bpvrqc9yn1.cloudfront.net/0311.gif")
exercise_20 = Exercise.create(name: 'dumbbell one arm reverse fly (with support)', gif: "http://d205bpvrqc9yn1.cloudfront.net/0359.gif")
exercise_21 = Exercise.create(name: 'dumbbell one arm upright row', gif: "http://d205bpvrqc9yn1.cloudfront.net/0363.gif")
# shoulders ^^
exercise_5 = Exercise.create(name: 'dumbbell seated bicep curl', gif: "http://d205bpvrqc9yn1.cloudfront.net/1677.gif")
exercise_22 = Exercise.create(name: 'cable rope incline tricep extension', gif: "http://d205bpvrqc9yn1.cloudfront.net/1725.gif")
exercise_23 = Exercise.create(name: 'cable rope hammer preacher curl', gif: "http://d205bpvrqc9yn1.cloudfront.net/1639.gif")
exercise_24 = Exercise.create(name: 'impossible dips', gif: "http://d205bpvrqc9yn1.cloudfront.net/3289.gif")
exercise_25 = Exercise.create(name: 'barbell lying triceps extension skull crusher', gif: "http://d205bpvrqc9yn1.cloudfront.net/0060.gif")
# arms ^^
